	...
	else
	{
		...
		{	
			...
			while( !quit )
			{
				...
				timeText.str( "" );
				timeText << "Milliseconds since start time " << (int)(SDL_GetTicks() - startTime) / 1000; 

				/*
					.str() is a member function of ostringstream, istringstream, and 
					stringstream.

					It means:

					"Give me the whole string inside the stream."
				*/
